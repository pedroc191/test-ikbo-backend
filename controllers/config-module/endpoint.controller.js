...
async function findDocument(req, res){
    ...
    try {
        ...
        if( format_data.is_valid ){
            ...
            let find_document = await h_crud.findDocument('Endpoint', backEndpointService, find_query, req.body.fields, req.body.options);
            ...
            res.status(400).send( h_response.request( false, format_data.valid_fields, 400, 'Error: Validate Data', 'Endpoint fields required not validated' ) );
        }
    } catch (process_error) {
        
        res.status(400).send( h_response.request( false, process_error, 400, 'Error: Endpoint find', 'Error in process' ) );
    }
};
/**
* 
...
async function listDocuments(req, res){
    ...
    let list_documents = await h_crud.listDocuments('Endpoint', backEndpointService, req.body.query, req.body.fields, req.body.options );
...
async function createDocument(req, res){
    ...
    try {
        let format_data = [
            ...
            h_format.objectValidField( 'model'           , h_validation.evalString( req.body.model, '' )         , h_format.fields.types.string.name     , h_format.fields.types.string.operators.not_equal      , '' ),
            h_format.objectValidField( 'request_method'  , h_validation.evalString( req.body.request_method, '' ), h_format.fields.types.string.name     , h_format.fields.types.string.operators.not_equal      , '' ),
            h_format.objectValidField( 'method'          , h_validation.evalString( req.body.method, '' )        , h_format.fields.types.string.name     , h_format.fields.types.string.operators.not_equal      , '' ),
            h_format.objectValidField( 'path'            , h_validation.evalString( req.body.path, '' )          , h_format.fields.types.string.name     , h_format.fields.types.string.operators.not_equal      , '' ),
        ...
        if( format_data.is_valid ){
            ...
            let create_document = await h_crud.createDocument( 'Endpoint', backEndpointService, { handle: format_data.body_object.handle }, format_data.body_object, true );
        ...
        res.status(400).send( h_response.request( false, process_error, 400, 'Error: Endpoint create', 'Error in process' ) );
    }
};
/**
* 
...
async function updateDocument(req, res){
    ...
    try {
        ...
        if( format_data.is_valid ) {
            ...
            let update_document = await h_crud.updateDocument('Endpoint', backEndpointService, find_query, format_data.body_object);
        ...
        res.status(400).send( h_response.request( false, process_error, 400, 'Error: Endpoint update', 'Error in process' ) );
    }
};
/**
* 
...
async function updateDocumentStatus(req, res){
    ...
    try {
        ...
        res.status(400).send( h_response.request( false, process_error, 400, 'Error: Endpoint update status', 'Error in process' ) );
    }
};
/**
* 
...
async function deleteDocument(req, res){
    ...
    try {
        ...
        if( format_data.is_valid ){
            ...
            let find_query      = h_format.findQuery( format_data.body_object.id_handle );
            let delete_document = await h_crud.deleteDocument('Endpoint', backEndpointService, find_query);
        ...
        res.status(400).send( h_response.request( false, process_error, 400, 'Error: Endpoint delete', 'Error in process' ) );
    }
};
// =============================================================================
// GENERAL FUNCTIONS
